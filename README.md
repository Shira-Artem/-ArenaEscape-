...
> [!WARNING]
> Добавление лицензии к собственному коду не даёт права распространять исходные файлы сторонних ассетов. Перед открытием репозитория необходимо проверить лицензии всех пакетов и исключить из публичной истории контент, который разрешено распространять только внутри собранной игры.
